...
if (have_posts()) : while (have_posts()) : the_post();
    ...
    <div id="slider1_container" style="display: none; position: relative; margin: 0 auto;
      top: 0px; left: -15px; height: 500px; overflow: hidden;">
        <!-- Loading Screen -->
        ...
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1450px; height: 500px; overflow: hidden;">
            <?php
